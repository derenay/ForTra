...
try:
    ...
    from modeldenemesi import HierarchicalFormationTransformer
...
MODEL_CONFIG = {
    ...
    'dropout_stages': [0.2, 0.1],  # Önerilen dropout oranları
    'use_adapter': True,
    'adapter_dim': 32,
...
DEFAULT_MODEL_PATH = "trained_models/hft_learnable_bias_run_20250410_110657/best_model.pth" 
